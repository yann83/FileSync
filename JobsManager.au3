...
Global $JobsListUpdate= GUICtrlCreateButton("Update", 320, 48, 97, 25)
GUICtrlSetFont(-1, 12, 400, 0, "MS Sans Serif")
...
Global $InputSource = GUICtrlCreateInput("Select a file or folder", 64, 136, 241, 28)
GUICtrlSetFont(-1, 12, 400, 0, "MS Sans Serif")
...
Global $InputTarget = GUICtrlCreateInput("Select a folder", 64, 176, 241, 28)
GUICtrlSetFont(-1, 12, 400, 0, "MS Sans Serif")
...
GUICtrlSetFont(-1, 12, 800, 0, "MS Sans Serif")
Global $Encrpyt = GUICtrlCreateCombo("", 254, 219, 50, 25, BitOR($CBS_DROPDOWN,$CBS_AUTOHSCROLL))
GUICtrlSetFont(-1, 12, 400, 0, "MS Sans Serif")
